...
export class Player {
    constructor(game) {
        ...
        this.weight = 1; //чтобы спрайт не взлетал далеко, а опускался плд "весом"
    ...
    update(input, deltaTime) {
        ...
        //Когда кнопки нажатыЮ спрайт движется с максимальной скоростью, которая прибавляется или отнимается когда скорость отрицательная от Х
        this.x += this.speed;
