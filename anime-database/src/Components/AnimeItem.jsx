...
// Компонент AnimeItem для отображения информации об аниме
export default function AnimeItem() {
    // Получение id из параметров маршрута
    const { id } =  useParams();

    // State для хранения данных об аниме, персонажах и флага для отображения/скрытия дополнительного текста
    const [anime, setAnime] = useState({});
    const [characters, setCharacters] = useState([]);
    const [showMore, setShowMore] = useState(false);

    // Деструктуризация данных об аниме
    const {
        title, synopsis, 
    ...
    // Функция для получения данных об аниме по его id
...
// Стилизованный компонент AnimeItemStyled
