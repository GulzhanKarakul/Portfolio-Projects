...
import { getPopularAnime, getAnimeById } from '../store/animeSlice/fetchFunctions'
...
export default function Homepage() {
    ...
    const topAnime = useSelector((state) => state.anime.curAnime);

    useEffect(() => {
        if (!popularAnime.length) {
            const fetchData = async () => {
                try {
                    await dispatch(getAnimeById('40748'));
